...
public class MenuHelper {
    ...
    public static void initStyleMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(styleMenu, "Подстрочный знак", new SubscriptAction(view));
        addMenuItem(styleMenu, "Надстрочный знак", new SuperscriptAction(view));
        addMenuItem(styleMenu, "Зачеркнутый", new StrikeThroughAction(view));
